 ...
 * @version 1.01
 */
public class ExactTwoStepTitleLinkMapping implements Serializable
{
  ...
  * @param wvc
  */
  public ExactTwoStepTitleLinkMapping(TermToVertexCount[] wvc)
  {
  ...
  */
  public ExactTwoStepTitleLinkMapping(String filename)
  {
    try
    {
  ...
  * @param wvm
  */
  public void joinMappings(ExactTwoStepTitleLinkMapping wvm)
  {
    int numToAdd = 0;
  ...
  /**
   * Write a {@link ExactTwoStepTitleLinkMapping} class to a file.
   * <p>
   ...
   */
   ...
   /**
    * Reads an {@link ExactTwoStepTitleLinkMapping} class from a file.
    * <p>
