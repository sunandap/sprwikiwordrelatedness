 ...
 * @version 1.01
 */
public class ApproximateOneStepTitleLinkMapping implements Serializable
{
  ...
  * @param wvc
  */
  public ApproximateOneStepTitleLinkMapping(TermToVertexCount[] wvc)
  {
  ...
  */
  public ApproximateOneStepTitleLinkMapping(String filename)
  {
    try
    {
  ...
  * @param wvm
  */
  public void joinMappings(ApproximateOneStepTitleLinkMapping wvm)
  {
    int numToAdd = 0;
  ...
  /**
   * Write a {@link ApproximateOneStepTitleLinkMapping} class to a file.
   * <p>
   ...
   */
   ...
   /**
    * Reads an {@link ApproximateOneStepTitleLinkMapping} class from a file.
    * <p>
