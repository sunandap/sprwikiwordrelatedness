 ...
 * @version 1.01
 */
public class ApproximateTwoStepTitleLinkMapping implements Serializable
{
  ...
  * @param wvc
  */
  public ApproximateTwoStepTitleLinkMapping(TermToVertexCount[] wvc)
  {
  ...
  */
  public ApproximateTwoStepTitleLinkMapping(String filename)
  {
    try
    {
  ...
  * @param wvm
  */
  public void joinMappings(ApproximateTwoStepTitleLinkMapping wvm)
  {
    int numToAdd = 0;
  ...
  /**
   * Write a {@link ApproximateTwoStepTitleLinkMapping} class to a file.
   * <p>
   ...
   */
   ...
   /**
    * Reads an {@link ApproximateTwoStepTitleLinkMapping} class from a file.
    * <p>
