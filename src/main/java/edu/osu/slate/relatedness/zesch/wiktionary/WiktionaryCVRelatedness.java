...
/**
 * Implements Concept Vector-based Relatedness for Wiktionary
 * <p>
 ...
 * 
 */
public class WiktionaryCVRelatedness implements WordRelatedness {
	...
	public WiktionaryCVRelatedness(String dir) {
		if(dir == null) {
	...
	public static void main(String [] args) {
		WiktionaryCVRelatedness fr = new WiktionaryCVRelatedness(null);
