...
import edu.osu.slate.relatedness.zesch.wordnet.WordNetCVRelatedness;
...
public class WNCVCorrelations {
  ...
  */
  public static void main(String [] args) throws IOException, ClassNotFoundException {
    ...
    WordNetCVRelatedness rr = new WordNetCVRelatedness("/u/weale/opt/jwnl14-rc2/config/file_properties.xml");
