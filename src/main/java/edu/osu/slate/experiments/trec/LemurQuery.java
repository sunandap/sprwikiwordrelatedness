...
//		Set<Entry<String,Double>> exSet = expansion.entrySet();
//		Iterator<Entry<String,Double>> itEX = exSet.iterator();
//		for(int i=0; i<10 && itEX.hasNext(); i++) {
//			Entry<String,Double> ex = itEX.next();
//			pw.print(ex.getKey() + "::" + ex.getValue() + " ");
//		}
