...
public class GenerateVertexTermFigure
{
  ...
  private static VertexToTermMapping vertex2TermF;
  private static VertexToTermMapping vertex2TermT;
  ...
  public static void main(String[] args)
  {
    ...
    {
      in = new ObjectInputStream(new FileInputStream(wordVertexMapFile));
      vertex2TermT = (VertexToTermMapping) in.readObject();
      in.close();
    }
    catch(Exception e)
    {
    ...
    // Get Histogram
    TreeMap<Integer,Integer> tmF = vertex2TermF.generateTermVertexHistogram();
    TreeMap<Integer,Integer> tmT = vertex2TermT.generateTermVertexHistogram();
    ...
    try
    {
      ...
      pw.println("title('Term-to-Vertex Mapping Distribution Using " +
                 Configuration.type + "-" +
                 Configuration.mapsource + "')");
      pw.println("xlabel('# Terms')");
      pw.println("ylabel('Percentage of Vertices')");
