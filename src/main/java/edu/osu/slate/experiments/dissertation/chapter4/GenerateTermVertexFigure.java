...
public class GenerateTermVertexFigure {
  ...
  public static void main(String[] args)
  {
    ...
    // Get Histogram
    TreeMap<Integer,Integer> tmF = word2VertexF.generateTermVertexHistogram();
    TreeMap<Integer,Integer> tmT = word2VertexT.generateTermVertexHistogram();
