...
public class SPRSynonymR3
{
  ...
  private static void setFiles() {
    ...
    rdwp300TaskFile = Configuration.taskDir + "/RDWP300.part";
  ...
  public static void main(String [] args) throws IOException, ClassNotFoundException {
    ...
    for(int i = 0; i < 16; i++)
    {
      (new Thread(new SPRThread(term2Vertex, wgp, rdwp300TaskFile + i,
          rdwp300ResultFile + i, rdwp300VertexFile + i))).start();
    }
  }//end: main
