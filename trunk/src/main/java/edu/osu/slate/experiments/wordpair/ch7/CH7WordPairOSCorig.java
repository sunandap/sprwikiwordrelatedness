...
package edu.osu.slate.experiments.wordpair.ch7;
 ...
 *
 */
public class CH7WordPairOSCorig
{
  ...
  private static String task, exp, alpha;
  ...
  private static void setFiles() {
    ...
    graphFile = dir + data + "-exp" + exp + "-" + alpha + ".wgp";   
  ...
  public static void main(String [] args) throws IOException, ClassNotFoundException
  {
    ...
    for(int currTask = 0; currTask < tasks.size(); currTask++)
    {
      ...
      {
        String experiment = "exp" + exp + "-" + alpha;
        (new Thread(new CH7WordPairSPRThreadOSCvect(term2Vertex, wgp, task, experiment, part))).start();
      }//end: for(part)
    }//end: for(currTask)
  }//end: main
