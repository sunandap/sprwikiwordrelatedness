 ...
 *
 */
public class CH7WordPairSPRThreadOSC extends Thread
{
   ...
   */
   public CH7WordPairSPRThreadOSC(TermToVertexMapping t2v, WikiGraph wg, String task, String exp, int part)
   {
     term2Vertex = t2v;
