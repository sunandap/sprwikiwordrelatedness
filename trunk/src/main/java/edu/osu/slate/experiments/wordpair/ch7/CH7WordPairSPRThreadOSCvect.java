 ...
 *
 */
public class CH7WordPairSPRThreadOSCvect extends Thread
{
   ...
   */
   public CH7WordPairSPRThreadOSCvect(TermToVertexMapping t2v, WikiGraph wg, String task, String exp, int part)
   {
     term2Vertex = t2v;
    ...
    while(s.hasNext())
    {
      ...
      for(int x = 0; vc1 != null && x <vc1.length; x++)
      {
        ...
        for(int y = 0; vc2 != null && y <vc2.length; y++)
        {
          ...
          double relValue = spr.getRelatedness(v1, v2);
          if(relValue > d12)
          {
            maxV11 = v1;
            maxV12 = v2;
