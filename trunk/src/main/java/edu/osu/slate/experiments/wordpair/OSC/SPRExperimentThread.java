 ...
 *
 */
public class SPRExperimentThread extends Thread
{
   ...
   */
   public SPRExperimentThread(TermToVertexMapping t2v, WikiGraph wg, String task, int part, double SPRbeta)
   {
     term2Vertex = t2v;
     spr = new SourcedPageRank(wg, SPRbeta);
     this.task = task;
     this.part = part;
     setFiles();
   }
