 ...
 * @version 1.01
 */
public class ExactOneStepTitleLinkMapping implements Serializable
{
  ...
  * @param wvc
  */
  public ExactOneStepTitleLinkMapping(TermToVertexCount[] wvc)
  {
  ...
  */
  public ExactOneStepTitleLinkMapping(String filename)
  {
    try
    {
  ...
  * @param wvm
  */
  public void joinMappings(ExactOneStepTitleLinkMapping wvm)
  {
    int numToAdd = 0;
  ...
  /**
   * Write a {@link ExactOneStepTitleLinkMapping} class to a file.
   * <p>
   ...
   */
   ...
   /**
    * Reads an {@link ExactOneStepTitleLinkMapping} class from a file.
    * <p>
