 ...
 * @version 1.01
 */
public class TrimmedOneStepTitleLinkMapping implements Serializable
{
  ...
  * @param wvc
  */
  public TrimmedOneStepTitleLinkMapping(TermToVertexCount[] wvc)
  {
  ...
  */
  public TrimmedOneStepTitleLinkMapping(String filename)
  {
    try
    {
  ...
  * @param wvm
  */
  public void joinMappings(TrimmedOneStepTitleLinkMapping wvm)
  {
    int numToAdd = 0;
  ...
  /**
   * Write a {@link TrimmedOneStepTitleLinkMapping} class to a file.
   * <p>
   ...
   */
   ...
   /**
    * Reads an {@link TrimmedOneStepTitleLinkMapping} class from a file.
    * <p>
