...
/**
 * Implements Concept Vector-based Relatedness Using Wikipedia
 * <p>
 ...
 * 
 */
public class WikipediaCVRelatedness implements WordRelatedness {
	...
	public WikipediaCVRelatedness(String dir) {
		if(dir == null) {
	...
	public static void main(String [] args) {
		WikipediaCVRelatedness fr = new WikipediaCVRelatedness(null);
